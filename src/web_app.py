...
st.write("""
Лабораторная работа **"Выбор рациональной маркетинговой стратегии с использованием uplift-моделирования"** знакомит студентов с основами поиска оптимальной стратегии коммуникаций бизнеса со своими клиентами. 
...
st.markdown('''#### Задание по Блоку 2:
\nПримените фильтры ниже для того, чтобы вручную отобрать клиентов, которые попадут в маркетинговую акцию''')
filters = {}
